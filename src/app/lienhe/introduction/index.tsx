    ...
    return (
        <div className="max-w-4xl my-4 mx-auto ml-4 p-6 bg-white shadow-md m-4">
            ...
            <p className="text-gray-700">
                Hơn 15 năm - một chặng đường với sự hình thành và phát triển không ngừng nghỉ cho đến nay. Kho Sim là
            ...
            <p className="text-gray-700">
                Khosim.com là website được công ty chúng tôi cho ra đời từ năm 2009 với mục đích phục vụ những người yêu
            ...
            <p className="text-gray-700">
                ...
                liên lạc với Kho sim qua thông tin sau:
                {/* ... Nội dung tiếp theo ... */}
            </p>
        </div>
    );
